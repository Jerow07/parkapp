...
export const BottomNavBar = () => {
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t-2 border-slate-200 shadow-[0_-4px_20px_rgba(0,0,0,0.05)] z-50">
      <div className="flex justify-around items-center max-w-lg mx-auto w-full h-[88px] pb-safe-bottom">
